...
#
# NAMED_TUPLE_USE_${Package}: Can be disabled by the user if he doesn't want to use that
#                      dependency.
# NAMED_TUPLE_HAS_${Package}: Internal flag. It should be used to check if a part of
#                      NAMED_TUPLE should be built. It is on if NAMED_TUPLE_USE_${Package}
#                      is on and either the package was found or will be built.
# NAMED_TUPLE_BUILD_${Package}: Internal flag. Used to check if NAMED_TUPLE has to build an
#                        external package.
# NAMED_TUPLE_BUILD_DEPS_${Package}: Internal flag. Used to check if dependencies
#                             required to build the package are available.
# NAMED_TUPLE_HAS_SYSTEM_${Package}: Internal flag. Used to check if the package is
#                             available on the system.
# NAMED_TUPLE_USE_SYSTEM_${Package}: This flag is shown only for packages in the
...
macro(checkandset_optional_dependency package)
  ...
  # NAMED_TUPLE_HAS_SYSTEM_${package}
  ...
  # NAMED_TUPLE_USE_SYSTEM_${package}
...
macro(NAMED_TUPLE_DEPENDENT_OPTION _option _doc _default _deps _force)
